    ...
    return(
        <div className="flex-col space-y-[10px]">
            ...
            {categoryData.length != 0 && categoryData.map((key:categoryDataObject) => (<div className="flex flex-col">
                <a href={`${key.id == 3 ? `/suggestion`:`/postListPage/${key.name}/${key.id}/1`}`} className="text-[20px] font-bold text-pink flex items-center mb-[5px]"><img src="/IconFile.svg"/>{key.name}</a>
