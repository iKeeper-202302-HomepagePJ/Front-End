...
import { setFieldDesign, } from '../../app/calendarPage/ComponentsTodoList'
...
export function writeTodoBox(year: string, month: string, day: string, calData: calObject) {  // 시간, 장소 나중에 미정 설정하기ㅣㅣㅣㅣㅣ
  ...
  const [todoField, setTodoField] = useState(calData.field)
  ...
  const saveTodo = () => {
    ...
    if (calData.id) transferTodoData.id = calData.id;
