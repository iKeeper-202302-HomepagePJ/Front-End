  ...
  return (
    <div className="flex items-center mb-4 text-[16px]">
      ...
      <input 
        ...
        className={`text-[14px] bg-blue border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 text-base px-2 py-1 cursor-pointer ${error ? 'border-red-500' : ''} mr-4 w-[550px] h-10`}
      />
